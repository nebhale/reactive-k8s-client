 ...
 * format <.spec.name>.<.spec.group>. Deprecated in v1.16, planned for removal in v1.22. Use apiextensions.k8s.io/v1
 * CustomResourceDefinition instead.
 */
@Builder
@Jacksonized
@Value
public class CustomResourceDefinition implements ObjectMeta, TypeMeta {

    public static final String GROUP = "apiextensions.k8s.io";

    public static final String KIND = "CustomResourceDefinition";

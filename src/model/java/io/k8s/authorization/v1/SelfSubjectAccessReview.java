...
/**
 * SelfSubjectAccessReview checks whether or the current user can perform an action.  Not filling in a spec.namespace
 * means "in all namespaces".  Self is a special case, because users should always be able to check whether they can
 * perform an action
 */
@Builder
@Jacksonized
@Value
public class SelfSubjectAccessReview implements ObjectMeta, TypeMeta {

    public static final String GROUP = "authorization.k8s.io";

    public static final String KIND = "SelfSubjectAccessReview";

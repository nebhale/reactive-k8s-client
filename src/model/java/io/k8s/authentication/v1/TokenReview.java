...
@Jacksonized
@Value
public class TokenReview implements ObjectMeta, TypeMeta {

    public static final String GROUP = "authentication.k8s.io";

    public static final String KIND = "TokenReview";

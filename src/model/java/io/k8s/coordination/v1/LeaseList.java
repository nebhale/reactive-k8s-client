...
package io.k8s.coordination.v1;
...
@Jacksonized
@Value
public class LeaseList implements ListMeta, TypeMeta {

    public static final String GROUP = "coordination.k8s.io";

    public static final String KIND = "LeaseList";

...
@Jacksonized
@Value
public class APIServiceList implements ListMeta, TypeMeta {

    public static final String GROUP = "apiregistration.k8s.io";

    public static final String KIND = "APIServiceList";

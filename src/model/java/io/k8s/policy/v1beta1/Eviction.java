...
/**
 * Eviction evicts a pod from its node subject to certain policies and safety constraints. This is a subresource of Pod.
 * A request to cause such an eviction is created by POSTing to .../pods/<pod name>/evictions.
 */
@Builder
@Jacksonized
@Value
public class Eviction implements ObjectMeta, TypeMeta {

    public static final String GROUP = "policy";

    public static final String KIND = "Eviction";

...
/**
 * PodSecurityPolicy governs the ability to make requests that affect the Security Context that will be applied to a pod
 * and container.
 */
@Builder
@Jacksonized
@Value
public class PodSecurityPolicy implements ObjectMeta, TypeMeta {

    public static final String GROUP = "policy";

    public static final String KIND = "PodSecurityPolicy";

...
@Jacksonized
@Value
public class HorizontalPodAutoscalerList implements ListMeta, TypeMeta {

    public static final String GROUP = "autoscaling";

    public static final String KIND = "HorizontalPodAutoscalerList";

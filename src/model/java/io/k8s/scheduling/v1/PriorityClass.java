...
/**
 * PriorityClass defines mapping from a priority class name to the priority integer value. The value can be any valid
 * integer.
 */
@Builder
@Jacksonized
@Value
public class PriorityClass implements ObjectMeta, TypeMeta {

    public static final String GROUP = "scheduling.k8s.io";

    public static final String KIND = "PriorityClass";
    ...
    /**
     * globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do
     * not have any priority class. Only one PriorityClass can be marked as `globalDefault`. However, if more than one
    ...
    /**
     * The value of this priority class. This is the actual priority that pods receive when they have the name of this

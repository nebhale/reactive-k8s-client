...
package io.k8s.events.v1beta1;

import io.k8s.core.v1.EventSource;
...
@Jacksonized
@Value
public class Event implements ObjectMeta, TypeMeta {

    public static final String GROUP = "events.k8s.io";
    ...
    /**
     * action is what action was taken/failed regarding to the regarding object. It is machine-readable. This field can
    ...
    @Nullable
    OffsetDateTime deprecatedFirstTimestamp;

    @Nullable
    OffsetDateTime deprecatedLastTimestamp;
    ...
    /**
     * note is a human-readable description of the status of this operation. Maximal length of the note is 1kB, but
     * libraries should be prepared to handle values up to 64kB.
     */
    @Nullable
    String note;
    ...
    /**
     * reportingController is the name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`. This
    ...
    /**
     * reportingInstance is the ID of the controller instance, e.g. `kubelet-xyzf`. This field cannot be empty for new

 ...
 * namespace, and adds who information via Subject.
 */
@Builder
@Jacksonized
@Value
public class ClusterRoleBinding implements ObjectMeta, TypeMeta {

    public static final String GROUP = "rbac.authorization.k8s.io";

    public static final String KIND = "ClusterRoleBinding";

 ...
 * rbac.authorization.k8s.io/v1 ClusterRoleBindingList, and will no longer be served in v1.22.
 */
@Builder
@Jacksonized
@Value
public class ClusterRoleBindingList implements ListMeta, TypeMeta {

    public static final String GROUP = "rbac.authorization.k8s.io";

    public static final String KIND = "ClusterRoleBindingList";

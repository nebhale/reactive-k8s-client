...
@Jacksonized
@Value
public class Secret implements ObjectMeta, TypeMeta {
     ...
     * modified). If not set to true, the field can be modified at any time. Defaulted to nil. This is a beta field

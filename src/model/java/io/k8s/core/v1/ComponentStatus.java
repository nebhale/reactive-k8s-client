...
/**
 * ComponentStatus (and ComponentStatusList) holds the cluster validation info. Deprecated: This API is deprecated in
 * v1.19+
 */
@Builder
@Jacksonized
@Value
public class ComponentStatus implements ObjectMeta, TypeMeta {

    public static final String GROUP = "";

    public static final String KIND = "ComponentStatus";

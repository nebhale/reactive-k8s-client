...
/**
 * Status of all the conditions for the component as a list of ComponentStatus objects. Deprecated: This API is
 * deprecated in v1.19+
 */
@Builder
@Jacksonized
@Value
public class ComponentStatusList implements ListMeta, TypeMeta {

    public static final String GROUP = "";

    public static final String KIND = "ComponentStatusList";

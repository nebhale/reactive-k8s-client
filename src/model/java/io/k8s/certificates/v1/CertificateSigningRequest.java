 ...
 * to authenticate to kube-apiserver (with the "kubernetes.io/kube-apiserver-client-kubelet" signerName).
 *  2. serving
...
@Jacksonized
@Value
public class CertificateSigningRequest implements ObjectMeta, TypeMeta {

    public static final String GROUP = "certificates.k8s.io";

    public static final String KIND = "CertificateSigningRequest";

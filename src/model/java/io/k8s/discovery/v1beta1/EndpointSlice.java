...
/**
 * EndpointSlice represents a subset of the endpoints that implement a service. For a given service there may be
 * multiple EndpointSlice objects, selected by labels, which must be joined to produce the full set of endpoints.
 */
@Builder
@Jacksonized
@Value
public class EndpointSlice implements ObjectMeta, TypeMeta {

    public static final String GROUP = "discovery.k8s.io";

    public static final String KIND = "EndpointSlice";

    public static final String VERSION = "v1beta1";

    /**
     * addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the
     * same type. This field is immutable after creation. The following address types are currently supported: * IPv4:
     * Represents an IPv4 Address. * IPv6: Represents an IPv6 Address. * FQDN: Represents a Fully Qualified Domain Name.
     */
    @NonNull
    String addressType;
    ...
    /**
     * ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique
     * name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port
     * value, it indicates "all ports". Each slice may include a maximum of 100 ports.
     */
    @Nullable
    @Singular

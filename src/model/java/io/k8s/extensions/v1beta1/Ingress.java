 ...
 * Ingress can be configured to give services externally-reachable urls, load balance traffic, terminate SSL, offer name
 * based virtual hosting etc. DEPRECATED - This group version of Ingress is deprecated by networking.k8s.io/v1beta1
 * Ingress. See the release notes for more information.
 */
@Builder
@Jacksonized
@Value
public class Ingress implements ObjectMeta, TypeMeta {

    public static final String GROUP = "extensions";

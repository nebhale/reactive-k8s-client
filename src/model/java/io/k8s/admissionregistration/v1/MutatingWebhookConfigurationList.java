...
@Jacksonized
@Value
public class MutatingWebhookConfigurationList implements ListMeta, TypeMeta {

    public static final String GROUP = "admissionregistration.k8s.io";

    public static final String KIND = "MutatingWebhookConfigurationList";
    ...
    @NonNull
    @Singular
    List<MutatingWebhookConfiguration> items;

...
@Jacksonized
@Value
public class ValidatingWebhookConfigurationList implements ListMeta, TypeMeta {

    public static final String GROUP = "admissionregistration.k8s.io";

    public static final String KIND = "ValidatingWebhookConfigurationList";
    ...
    @NonNull
    @Singular
    List<ValidatingWebhookConfiguration> items;

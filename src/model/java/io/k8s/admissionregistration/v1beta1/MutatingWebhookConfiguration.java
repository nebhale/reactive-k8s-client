...
/**
 * MutatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and may
 * change the object. Deprecated in v1.16, planned for removal in v1.19. Use admissionregistration.k8s.io/v1
 * MutatingWebhookConfiguration instead.
 */
@Builder
@Jacksonized
@Value
public class MutatingWebhookConfiguration implements ObjectMeta, TypeMeta {

    public static final String GROUP = "admissionregistration.k8s.io";

    public static final String KIND = "MutatingWebhookConfiguration";

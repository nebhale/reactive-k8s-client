 ...
 * without changing it. Deprecated in v1.16, planned for removal in v1.19. Use admissionregistration.k8s.io/v1
 * ValidatingWebhookConfiguration instead.
 */
@Builder
@Jacksonized
@Value
public class ValidatingWebhookConfiguration implements ObjectMeta, TypeMeta {

    public static final String GROUP = "admissionregistration.k8s.io";

    public static final String KIND = "ValidatingWebhookConfiguration";

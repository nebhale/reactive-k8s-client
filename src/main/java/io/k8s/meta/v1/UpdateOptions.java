...
/**
 * UpdateOptions may be provided when updating an API object. All fields in UpdateOptions should also be present in
 * PatchOptions.
 */
@Builder
@Jacksonized
@Value
public class UpdateOptions implements TypeMeta {

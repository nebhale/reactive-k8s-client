...
import io.k8s.core.v1.Endpoints;
import io.k8s.core.v1.EndpointsList;
...
public interface EndpointsClient {
     ...
     * create Endpoints
     */
    Mono<Endpoints> create(Endpoints body, CreateOptions options);
     ...
     */
    Mono<Endpoints> get(String name, GetOptions options);

    /**
     * list or watch objects of kind Endpoints
     */
    Mono<EndpointsList> list(ListOptions options);

    /**
     * partially update the specified Endpoints
     */
    Mono<Endpoints> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

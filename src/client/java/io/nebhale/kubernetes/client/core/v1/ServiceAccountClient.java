...
import io.k8s.core.v1.ServiceAccount;
import io.k8s.core.v1.ServiceAccountList;
...
public interface ServiceAccountClient {
     ...
     */
    Mono<ServiceAccount> create(ServiceAccount body, CreateOptions options);

    /**
     * delete a ServiceAccount
     */
    Mono<ServiceAccount> delete(String name, DeleteOptions body);
     ...
     */
    Mono<ServiceAccount> get(String name, GetOptions options);

    /**
     * list or watch objects of kind ServiceAccount
     */
    Mono<ServiceAccountList> list(ListOptions options);

    /**
     * partially update the specified ServiceAccount
     */
    Mono<ServiceAccount> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

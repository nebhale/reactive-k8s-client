...
import io.k8s.core.v1.ConfigMap;
import io.k8s.core.v1.ConfigMapList;
...
public interface ConfigMapClient {
     ...
     * create a ConfigMap
     */
    Mono<ConfigMap> create(ConfigMap body, CreateOptions options);
     ...
     */
    Mono<ConfigMap> get(String name, GetOptions options);

    /**
     * list or watch objects of kind ConfigMap
     */
    Mono<ConfigMapList> list(ListOptions options);

    /**
     * partially update the specified ConfigMap
     */
    Mono<ConfigMap> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

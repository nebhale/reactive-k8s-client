...
import io.k8s.storage.v1beta1.CSINode;
import io.k8s.storage.v1beta1.CSINodeList;
import io.k8s.type.PatchType;
import reactor.core.publisher.Mono;

public interface CSINodeClient {

    /**
     * create a CSINode
     */
    Mono<CSINode> create(CSINode body, CreateOptions options);

    /**
     * delete a CSINode
     */
    Mono<CSINode> delete(String name, DeleteOptions body);
     ...
     */
    Mono<CSINode> get(String name, GetOptions options);

    /**
     * list or watch objects of kind CSINode
     */
    Mono<CSINodeList> list(ListOptions options);

    /**
     * partially update the specified CSINode
     */
    Mono<CSINode> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

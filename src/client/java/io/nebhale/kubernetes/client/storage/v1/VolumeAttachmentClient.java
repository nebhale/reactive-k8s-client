...
import io.k8s.storage.v1.VolumeAttachment;
import io.k8s.storage.v1.VolumeAttachmentList;
...
public interface VolumeAttachmentClient {
     ...
     */
    Mono<VolumeAttachment> getStatus(String name, GetOptions options);
     ...
     */
    Mono<VolumeAttachment> patchStatus(String name, PatchType type, Object body, PatchOptions options, String... subresources);

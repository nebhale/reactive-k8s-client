...
import io.k8s.rbac.v1.RoleBinding;
import io.k8s.rbac.v1.RoleBindingList;
import io.k8s.type.PatchType;
import reactor.core.publisher.Mono;

public interface RoleBindingClient {

    /**
     * create a RoleBinding
     */
    Mono<RoleBinding> create(RoleBinding body, CreateOptions options);
     ...
     */
    Mono<RoleBinding> get(String name, GetOptions options);

    /**
     * list or watch objects of kind RoleBinding
     */
    Mono<RoleBindingList> list(ListOptions options);

    /**
     * partially update the specified RoleBinding
     */
    Mono<RoleBinding> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

...
import io.k8s.rbac.v1.Role;
import io.k8s.rbac.v1.RoleList;
...
public interface RoleClient {
     ...
     * create a Role
     */
    Mono<Role> create(Role body, CreateOptions options);
     ...
     */
    Mono<Role> get(String name, GetOptions options);

    /**
     * list or watch objects of kind Role
     */
    Mono<RoleList> list(ListOptions options);

    /**
     * partially update the specified Role
     */
    Mono<Role> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

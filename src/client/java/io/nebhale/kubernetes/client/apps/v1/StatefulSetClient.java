...
import io.k8s.apps.v1.StatefulSet;
import io.k8s.apps.v1.StatefulSetList;
...
public interface StatefulSetClient {
     ...
     */
    Mono<StatefulSet> create(StatefulSet body, CreateOptions options);
     ...
     */
    Mono<StatefulSet> get(String name, GetOptions options);

    /**
     * read status of the specified StatefulSet
     */
    Mono<StatefulSet> getStatus(String name, GetOptions options);

    /**
     * list or watch objects of kind StatefulSet
     */
    Mono<StatefulSetList> list(ListOptions options);

    /**
     * partially update the specified StatefulSet
     */
    Mono<StatefulSet> patch(String name, PatchType type, Object body, PatchOptions options, String... subresources);

    /**
     * partially update status of the specified StatefulSet
     */
    Mono<StatefulSet> patchStatus(String name, PatchType type, Object body, PatchOptions options, String... subresources);
